...
import { getAccount, updateAccount } from '../logic/User'
...
function Signup() {
  ...
  return (
    <Authenticator>
      <Navigation />
      <div className="Waggly">
        <form className="Form">
          <h1 id="heading">Become a Walker</h1>
          <p id="subheading">
            Have a passion for Dogs? - Waggly makes it easy to promote yourself
            to a network of dog owners.
          </p>
          <div id="fields">
            <div>
              ...
              <div>
                ...
                <input
                  onChange={event => {
                    setFromData({ ...formData, POSTCODE: event.target.value })
                  }}
                />
              </div>
            </div>
